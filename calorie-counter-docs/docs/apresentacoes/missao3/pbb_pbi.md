...
|--------|-------------|---------|----------------------------|---------|
| **US01** | Maria (Recepcionista) | Registrar novos pacientes | 1. Maria deve ser capaz de registrar novos pacientes sem atrasos.<br>2. O sistema deve garantir que todos os campos obrigatórios estão preenchidos antes de permitir o registro. | 1. Edição de Dados <br> Dado que exista um paciente chamado João da Silva Barreto, que mora na Quadra 520 conjunto I, lote 35 do Recanto das Emas, número de celular (61)985732038, estado civil Solteiro <br> Quando a recepcionista alterar o endereço do paciente para Riacho Fundo 20, C304, o número de celular para (61)995789334 e o estado Civil para Casado Então, o paciente deve constar no sistema com endereço, Riacho Fundo 20, C304, o número de celular para (61)995789334 e o estado Civil para Casado. |
